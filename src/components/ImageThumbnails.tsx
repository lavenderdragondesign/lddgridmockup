  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 max-h-60 overflow-y-auto pr-2">
        {images.slice().reverse().map((imgData, index) => {
          ...
          return (
            ...
            >
              <img src={imgData.url} alt={`upload-${originalIndex}`} className="w-full h-full object-cover rounded-md bg-gray-200 dark:bg-gray-700 pointer-events-none" />
